 ...
 * @author geraldo
 */
public class frmvizitprodukti extends javax.swing.JFrame {

    /**
     * Creates new form frmvizitprodukti
     */
    public frmvizitprodukti() {
        initComponents();
        moster("");
    ...
    private void initComponents() {
        ...
        jPanel2Layout.setVerticalGroup(
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addGap(31, 31, 31)
                .addComponent(lbltotalregjister, javax.swing.GroupLayout.PREFERRED_SIZE, 33, javax.swing.GroupLayout.PREFERRED_SIZE))
        );
    ...
    private void listtabeleMousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_listtabeleMousePressed
        ...
        if (evt.getClickCount()==2){
            ...
            valor1=listtabele.getValueAt(fila, 1).toString();
            valor2=listtabele.getValueAt(fila, 4).toString();
        
            frmkonsumatori.txtidprodukti.setText(cod);
            frmkonsumatori.txtprodukti.setText(valor1);
        frmkonsumatori.txtulje_cemimi.setText(valor2);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(frmvizitprodukti.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new frmvizitprodukti().setVisible(true);
            }
        });
    }
